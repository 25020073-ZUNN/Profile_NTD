...
function createPlaceholder(id) {
  const placeholders = [
    ...
    { id: 4, title: 'Công cụ hợp tác trực tuyến', subtitle: 'Bài tập 3 - Mục 4.1', icon: '👥', description: 'Báo cáo cá nhân: Kế hoạch và kết quả thực hiện nhiệm vụ nhóm (BiddingApplication) sử dụng Trello, Google Docs, GitHub, Discord.', tags: ['Collaboration', 'Trello', 'GitHub', 'Discord', 'Google Docs'], status: 'done' },
